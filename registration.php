...
if (isset($_POST['form1'])) {
    ...
    // Kiểm tra mật khẩu có ít nhất một ký tự thường
    if (!preg_match('/[a-z]/', $_POST['cust_password'])) {
        $valid = 0;
        $error_message .= "Mật khẩu phải chứa ít nhất một ký tự thường.<br>";
    }

    // Kiểm tra mật khẩu có ít nhất một ký tự hoa
    if (!preg_match('/[A-Z]/', $_POST['cust_password'])) {
        $valid = 0;
        $error_message .= "Mật khẩu phải chứa ít nhất một ký tự hoa.<br>";
    }

    // Kiểm tra mật khẩu có ít nhất một chữ số
    if (!preg_match('/[0-9]/', $_POST['cust_password'])) {
        $valid = 0;
        $error_message .= "Mật khẩu phải chứa ít nhất một chữ số.<br>";
    }

    // Kiểm tra mật khẩu có độ dài lớn hơn 8 ký tự
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="password" class="form-control" name="cust_password" value="<?php if (isset($_POST['cust_password'])) {
                                                                                                                echo $_POST['cust_password'];
                                                                                                            } ?>">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label for=""><?php echo LANG_VALUE_98; ?> *</label>
                                    <input type="password" class="form-control" name="cust_re_password" value="<?php if (isset($_POST['cust_re_password'])) {
                                                                                                                    echo $_POST['cust_re_password'];
                                                                                                                } ?>">
                                </div>
